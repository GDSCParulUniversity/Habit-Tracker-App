...
class _TrackScreenState extends State<TrackScreen> {
  ...
  double _workingSessionSlider = 20;
  double _longBreakSlider = 20;
  double _shortBreakSlider = 20;
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
                    ...
                    children: [
                      ...
                      InkWell(
                        onTap: () async {
                          ...
                          if (pickedDate != null) {
                            //pickedDate output format => 3021-03-10 00:00:00.000
                            String formattedDate =
                                DateFormat('yyyy-MM-dd').format(pickedDate);
                            print(
                                formattedDate); //formatted date output using intl package =>  3021-03-16
                            setState(() {
                              this.pickedData =
              ...
              Slider(
                value: _workingSessionSlider,
                activeColor: AppColors.primaryColor,
                inactiveColor: AppColors.greyColor,
                thumbColor: AppColors.primaryColor,
                max: 100,
                label: _workingSessionSlider.round().toString(),
                onChanged: (double value) {
                  setState(() {
                    _workingSessionSlider = value;
                  });
                },
              ),
              SizedBox(
              ...
              Slider(
                value: _longBreakSlider,
                activeColor: AppColors.primaryColor,
                inactiveColor: AppColors.greyColor,
                thumbColor: AppColors.primaryColor,
                max: 100,
                label: _longBreakSlider.round().toString(),
                onChanged: (double value) {
                  setState(() {
                    _longBreakSlider = value;
                  });
                },
              ),
              SizedBox(
              ...
              Slider(
                value: _shortBreakSlider,
                activeColor: AppColors.primaryColor,
                inactiveColor: AppColors.greyColor,
                thumbColor: AppColors.primaryColor,
                max: 100,
                label: _shortBreakSlider.round().toString(),
                onChanged: (double value) {
                  setState(() {
                    _shortBreakSlider = value;
                  });
                },
              ),
            ],
